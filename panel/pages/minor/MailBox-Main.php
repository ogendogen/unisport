<?php \Utils\Front::printPageDesc("Skrzynka odbiorcza", "Wiadomości prywatne"); ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Wiadomości odebrane</h3>
            ...
            <div class="box-body no-padding">
                ...
                <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                        ...
                        try
                        {
                            $messages = \User\Message::getAllUserMessages($_SESSION["userid"]);
